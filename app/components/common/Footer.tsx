      ...
      <div className="container space-x-5 flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3 ">
          ...
          >
            ...
            <div>
              <p className="self-center text-sm font-light">
              ...
              <p className="self-center text-sm font-light">
                <span className="self-center text-sm font-normal">Email: </span>
                info@iconmenstore.com
              </p>
              <p className="self-center text-sm font-light">
                <span className="self-center text-sm font-normal">
                  Timing:{" "}
              ...
              <p className="self-center text-sm font-light">
                ...
                Yv Street Kadapa Big bazaar complex, near by muniro street,
